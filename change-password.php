...
if (!isset($_SESSION['adlogin'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = mysqli_query($con, "SELECT * FROM  users where  name='" . $_SESSION['adlogin'] . "'");
        $num = mysqli_fetch_array($sql);


        if (strcmp($num['password'], md5($_POST['password'])) == 0) {
            $sql2 = mysqli_query($con, "update users set password='" . md5($_POST['newpassword']) . "' where name='" . $_SESSION['adlogin'] . "'");
            $_SESSION["pwd-change"] = "yes";
