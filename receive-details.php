                    ...
                    <div class="module">
                        ...
                        <div class="module-body">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0"
                                ...
                                $ret = mysqli_query($con, "select * from receive_item where issue_id='$orderid'");
                            ...
                            <table>
                                <ul style="list-style: none;">
                                    ...
                                    <?php
                                    $ret = mysqli_query($con, "select * from receive_main where id='$orderid'");
